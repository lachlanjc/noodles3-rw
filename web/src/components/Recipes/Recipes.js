      ...
      <table className="table-auto w-full min-w-3xl text-sm">
        <thead>
          <tr className="bg-gray-300 text-gray-700">
            ...
            <th className="font-semibold text-left p-3">cooksCount</th>
            <th className="font-semibold text-left p-3">lastCookedAt</th>
        ...
        <tbody>
          {recipes.map((recipe) => (
            ...
            >
              ...
              <td className="p-3">{truncate(recipe.description)}</td>
              ...
              <td className="p-3">{truncate(recipe.image)}</td>
              <td className="p-3">{truncate(recipe.isFavorite)}</td>
              <td className="p-3">{truncate(recipe.cooksCount)}</td>
              <td className="p-3">{timeTag(recipe.lastCookedAt)}</td>
